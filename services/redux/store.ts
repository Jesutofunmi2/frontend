...
import selectedLanguageSlice from "./features/selectedLanguageSlice";
  ...
  const rootReducer = combineReducers({user: userSlice, lessonGame: lessonGameSlice, selectedLanguage: selectedLanguageSlice, lessons: lessonsSlice, survey:surveySlice, tab: tabSlice});
