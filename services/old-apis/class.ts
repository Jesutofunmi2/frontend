...
//     `/api/v1/showSchoolClasses?school_id=${schoolID}`,
//     fetcher
//   )
...
// //ADD CLASS ARM
// export const useAddClassArm = (payloadData: { school_id: string; class_id: number; language_id: string; data: never[] }, mutate: () => void) => {
//   async function sendRequest(url: string, { arg }) {
//     toast.loading('Submitting...', {
//       position: toast.POSITION.TOP_RIGHT,
//     })
